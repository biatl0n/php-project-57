<x-app-layout>
    <x-section>
        <div class="grid col-span-full">
            ...
            <x-div>
                <x-text-input id="name" name="name" type="text" value="{{ $task->name }}" :value="old('name', $task->name)" autofocus />
            ...
            <x-div>
                <x-textarea name="description" id="description" value="{{ $task->description }}" :value="old('description', $task->description)" />
            </x-div>
